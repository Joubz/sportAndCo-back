...
SELECT
    ...
    RENTING_CLIENT.FIRST_NAME AS CLIENT_FIRST_NAME,
    RENTING_CLIENT.LAST_NAME AS CLIENT_LAST_NAME,
    RENTING_CLIENT.EMAIL AS CLIENT_EMAIL,
    RENTING_CLIENT.BIRTH_DATE AS CLIENT_BIRTH_DATE,
    RENTING_CLIENT.ADDRESS AS CLIENT_ADDRESS,
    RENTING_CLIENT.ADDITIONNAL_ADDRESS AS CLIENT_ADDITIONNAL_ADDRESS,
    RENTING_CLIENT.POSTAL_CODE AS CLIENT_POSTAL_CODE,
    RENTING_CLIENT.CITY AS CLIENT_CITY,
...
FROM
    (((((EQUIPMENT_ORDER
        JOIN RENTING_CLIENT ON (EQUIPMENT_ORDER.CLIENT_ID = RENTING_CLIENT.CLIENT_ID))
